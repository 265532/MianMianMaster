...
const progress = computed(() => {
  ...
  return (
    ((currentQuestionIndex.value + 1) / practiceData.value.questions.length) *
    100
  );
});
    ...
    <main class="px-4 py-8">
      ...
      <div v-else>
        ...
        <div class="mb-4">
          <div class="flex justify-between text-sm text-neutral-helper mb-2">
            ...
            <span
              ...
              {{ practiceData.questions.length }}</span
            >
          </div>
        ...
        <div v-if="showResult" class="text-center py-12">
          <div
            class="w-24 h-24 rounded-full bg-auxiliary-green/10 flex items-center justify-center mx-auto mb-6"
          >
        ...
        <div v-else class="space-y-4">
          ...
          >
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 class="text-lg font-bold text-neutral-title mb-2">
            ...
            >
              ...
              >
                <div class="flex items-center gap-3">
                  <div
                    class="w-6 h-6 rounded-full border-2 border-neutral-border flex items-center justify-center"
                    :class="
                      selectedAnswers[currentQuestion.id] === option.id
                  ...
                  <span class="text-sm text-neutral-title">{{
                    option.text
                  }}</span>
                </div>
              </div>
