...
const analyzeResume = () => {
  ...
  setTimeout(() => {
    ...
    resumeAnalysisResult.value =
      "根据您的简历，您在 Vue.js 和 TypeScript 方面有深厚背景，适合高级前端开发工程师岗位。";
  }, 2000);
};
...
const generateQuestions = (): string[] => {
  ...
  if (mode === "technical" && job) {
    ...
    const categories = Object.keys(questionBank.behavioral) as Array<
      keyof typeof questionBank.behavioral
    >;
    categories.forEach((category) => {
      const categoryQuestions =
        questionBank.behavioral[category]?.[level] || [];
    ...
    while (questions.length < 5) {
      ...
      if (randomCategory) {
        const categoryQuestions =
          questionBank.behavioral[randomCategory]?.[level] || [];
        if (categoryQuestions.length > 0) {
          const randomQ =
            categoryQuestions[
              Math.floor(Math.random() * categoryQuestions.length)
    ...
    const scenarios = Object.keys(questionBank.pressure) as Array<
      keyof typeof questionBank.pressure
    >;
    scenarios.forEach((scenario) => {
      ...
      if (scenarioQuestions.length > 0) {
        const randomQ =
          scenarioQuestions[
            Math.floor(Math.random() * scenarioQuestions.length)
          ];
        if (randomQ) {
          questions.push(randomQ);
        }
    ...
    while (questions.length < 5) {
      ...
      if (randomScenario) {
        const scenarioQuestions =
          questionBank.pressure[randomScenario]?.[level] || [];
        if (scenarioQuestions.length > 0) {
          const randomQ =
            scenarioQuestions[
              Math.floor(Math.random() * scenarioQuestions.length)
  ...
  types: [
    {
      ...
      icon: "Languages",
      description:
        "前端开发是创建Web页面或应用程序前端部分的过程，负责用户界面和用户体验。随着Web技术的快速发展，前端开发已经从简单的HTML/CSS编码转变为复杂的单页应用开发，需要掌握多种框架和工具。",
      skills: [
        "HTML5/CSS3",
      ...
      careerPaths: [
        {
          title: "前端开发工程师",
          description: "负责Web应用的前端开发，实现用户界面和交互功能",
          salary: "15k-25k",
        },
        {
          title: "高级前端开发工程师",
          description: "负责复杂前端项目的架构设计和技术选型，指导初级工程师",
          salary: "25k-35k",
        },
        {
          title: "前端技术专家",
          description: "专注于前端技术的研究和创新，推动技术团队的技术进步",
          salary: "35k-50k",
        },
        {
          title: "全栈开发工程师",
          description: "同时负责前端和后端开发，能够独立完成整个应用的开发",
          salary: "20k-40k",
        },
      ],
      trends: [
    ...
    },
    {
      ...
      icon: "Server",
      description:
        "后端开发负责服务器端逻辑，数据库管理，API设计和集成，确保应用程序的核心功能正常运行。后端开发需要掌握多种编程语言、数据库系统和服务器架构，以构建高性能、可扩展的服务。",
      skills: [
        "Java/Python/Node.js/Golang",
      ...
      careerPaths: [
        {
          title: "后端开发工程师",
          description: "负责服务器端应用的开发和维护，实现核心业务逻辑",
          salary: "15k-25k",
        },
        {
          title: "高级后端开发工程师",
          description: "负责后端系统的架构设计和性能优化，解决复杂技术问题",
          salary: "25k-35k",
        },
        {
          title: "后端技术专家",
          description: "专注于后端技术的研究和创新，推动技术团队的技术进步",
          salary: "35k-50k",
        },
        {
          title: "架构师",
          description:
            "负责整个系统的架构设计和技术决策，确保系统的可扩展性和可靠性",
          salary: "40k-60k",
        },
      ],
      trends: [
    ...
    },
    {
      ...
      icon: "Code",
      description:
        "全栈开发工程师具备前端和后端开发能力，能够独立完成整个应用程序的开发。全栈开发需要掌握多种技术栈，能够理解整个系统的架构和工作原理。",
      skills: [
        "HTML/CSS/JavaScript",
      ...
      careerPaths: [
        {
          title: "全栈开发工程师",
          description: "负责整个应用的开发，包括前端和后端",
          salary: "18k-30k",
        },
        {
          title: "高级全栈开发工程师",
          description: "负责复杂全栈项目的架构设计和技术选型",
          salary: "30k-40k",
        },
        {
          title: "技术负责人",
          description: "负责技术团队的管理和技术决策，推动项目的顺利进行",
          salary: "35k-50k",
        },
        {
          title: "CTO",
          description: "负责公司的技术战略和技术团队的管理，推动公司技术的发展",
          salary: "50k+",
        },
      ],
      trends: [
    ...
    },
    {
      ...
      icon: "Smartphone",
      description:
        "移动开发负责开发移动应用程序，包括原生应用和跨平台应用。移动开发需要考虑不同设备的屏幕尺寸、性能限制和用户体验，以构建流畅、响应迅速的移动应用。",
      skills: [
        "Swift/Kotlin",
      ...
      careerPaths: [
        {
          title: "移动开发工程师",
          description: "负责移动应用的开发和维护，实现核心功能和用户界面",
          salary: "15k-25k",
        },
        {
          title: "高级移动开发工程师",
          description: "负责移动应用的架构设计和性能优化，解决复杂技术问题",
          salary: "25k-35k",
        },
        {
          title: "移动技术专家",
          description: "专注于移动技术的研究和创新，推动技术团队的技术进步",
          salary: "35k-45k",
        },
        {
          title: "移动产品负责人",
          description: "负责移动产品的规划和管理，协调开发、设计和测试团队",
          salary: "20k-40k",
        },
      ],
      trends: [
    ...
    },
    {
      ...
      icon: "Cloud",
      description:
        "DevOps是一种软件开发方法论，强调开发和运维团队之间的协作，以提高软件交付速度和质量。DevOps工程师负责构建和维护CI/CD管道，确保应用的快速部署和稳定运行。",
      skills: [
...
基础设施即代码是DevOps的核心实践之一，它可以提高基础设施管理的效率和可靠性，减少人为错误，确保环境的一致性。`,
      ...
      careerPaths: [
        {
          title: "DevOps工程师",
          description:
            "负责CI/CD管道的构建和维护，确保应用的快速部署和稳定运行",
          salary: "18k-28k",
        },
        {
          title: "SRE工程师",
          description: "负责系统的可靠性和性能，确保服务的高可用性",
          salary: "25k-35k",
        },
        {
          title: "云平台工程师",
          description: "负责云基础设施的设计和管理，优化云资源的使用",
          salary: "20k-30k",
        },
        {
          title: "DevOps经理",
          description: "负责DevOps团队的管理和战略规划，推动DevOps实践的落地",
          salary: "30k-45k",
        },
      ],
      trends: [
    ...
    },
    {
      ...
      icon: "Brain",
      description:
        "AI算法工程师负责设计、开发和优化人工智能算法，以解决各种复杂问题。AI算法工程师需要掌握机器学习、深度学习等技术，能够将AI技术应用到实际业务场景中。",
      skills: [
        "Machine Learning",
        "Deep Learning",
        "Data Analysis",
...
防止过拟合是机器学习中的重要挑战，需要通过多种方法的组合使用来提高模型的泛化能力。`,
   ...
   if __name__ == '__main__':
      ...
      careerPaths: [
        {
          title: "AI算法工程师",
          description: "负责AI算法的设计和开发，将AI技术应用到实际业务场景中",
          salary: "20k-35k",
        },
        {
          title: "机器学习工程师",
          description: "负责机器学习模型的训练和优化，提高模型的性能和准确性",
          salary: "25k-40k",
        },
        {
          title: "数据科学家",
          description: "负责数据分析和建模，从数据中提取有价值的 insights",
          salary: "20k-35k",
        },
        {
          title: "AI研究科学家",
          description: "负责AI技术的前沿研究和创新，推动AI技术的发展",
          salary: "35k-60k",
        },
      ],
      trends: [
  ...
  difficulty: [
    {
      level: "easy",
      name: "入门级",
      description: "适合初学者，基础概念考查",
      color: "bg-auxiliary-green",
    },
    {
      level: "medium",
      name: "进阶级",
      description: "适合有一定经验的开发者",
      color: "bg-primary",
    },
    {
      level: "hard",
      name: "专家级",
      description: "适合高级工程师，深度技术考查",
  ...
  commonQuestions: [
    {
      ...
      category: "团队协作",
      description:
        "这个问题考查你如何处理团队内部的冲突，以及你的沟通和解决问题的能力。面试官希望了解你是否能够以建设性的方式解决冲突，而不是激化矛盾。",
      starAnswer: {
        situation:
          "在我之前的项目中，我和一位团队成员在技术实现方案上产生了分歧。我倾向于使用新框架，而他坚持使用传统方法。",
        task: "我需要找到一种方法来解决这个冲突，确保项目能够顺利进行，同时保持团队的和谐。",
        action:
          "我首先与他进行了一对一的沟通，了解他的顾虑。他担心新框架的稳定性和学习成本。然后我收集了相关数据和案例，证明新框架的优势，并提出了分阶段迁移的方案，以降低风险。最后，我们进行了小组讨论，共同评估两种方案的优缺点。",
        result:
          "最终，我们决定采用新框架，并成功完成了项目，比预期时间提前了10%。这次经历也加强了我们之间的合作关系，他后来成为了新框架的积极推广者。",
      },
      alternativeAnswers: [
        {
          situation:
            "在一个跨部门项目中，市场部门和开发部门在功能优先级上产生了冲突。市场部门希望优先开发用户界面功能，而开发部门希望优先解决后端架构问题。",
          task: "作为项目协调人，我需要找到一个平衡点，确保两个部门的需求都能得到满足。",
          action:
            "我组织了一次跨部门会议，让双方充分表达各自的观点和理由。然后我提出了一个分阶段的开发计划，先解决后端架构的关键问题，同时开始用户界面的设计工作，这样两个部门可以并行工作。",
          result:
            "通过这种方式，我们既保证了系统的稳定性，又满足了市场部门的需求，项目最终按时交付，得到了高层的认可。",
        },
      ],
      commonMistakes: [
        "将冲突归咎于他人，而不是分析问题本身",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，合规和风险控制是关键。强调你如何在遵守 regulations 的前提下解决冲突，确保业务目标的实现。",
        healthcare:
          "在医疗行业，患者安全是首要考虑。强调你如何在保证患者安全的前提下解决团队冲突，确保医疗质量。",
      },
      tips: [
        "保持冷静，避免情绪化",
        "倾听对方的观点，理解其顾虑",
    ...
    },
    {
      ...
      category: "自我认知",
      description:
        "这个问题考查你的自我反思能力和从失败中学习的能力。面试官希望了解你是否能够诚实面对失败，分析原因，并从中吸取教训。",
      starAnswer: {
        situation:
          "在我负责的一个项目中，由于我对时间估计不足，导致项目延期交付，给客户带来了不便。",
        task: "我需要分析失败的原因，并采取措施确保类似问题不再发生。",
        action:
          "我首先向客户道歉并解释情况，然后与团队一起加班完成项目。之后，我对整个过程进行了复盘，识别出时间估计不足的原因：我没有充分考虑到第三方API集成的复杂性和潜在的技术风险。我制定了更准确的项目规划方法，包括更详细的任务分解和风险评估。",
        result:
          "通过这次经历，我学会了更全面地评估项目风险和时间需求，并且在之后的项目中都能按时或提前交付。我还开发了一个项目风险评估模板，被团队广泛采用。",
      },
      alternativeAnswers: [
        {
          situation:
            "我曾经负责一个产品的市场推广活动，但活动效果远低于预期，没有达到销售目标。",
          task: "我需要分析活动失败的原因，并提出改进措施。",
          action:
            "我收集了活动数据，进行了用户调研，并与团队成员进行了深入讨论。我发现问题在于目标受众定位不准确，推广渠道选择不当，以及活动内容不够吸引人。我重新制定了推广策略，调整了目标受众和渠道，并优化了活动内容。",
          result:
            "在后续的推广活动中，我们的转化率提高了30%，成功达到了销售目标。这次经历让我深刻认识到市场调研和数据分析的重要性。",
        },
      ],
      commonMistakes: [
        "回避失败，只谈论成功经历",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，风险管理至关重要。强调你如何从失败中识别风险因素，完善风险控制机制。",
        healthcare:
          "在医疗行业，错误可能带来严重后果。强调你如何从失败中学习，改进医疗流程和患者安全措施。",
      },
      tips: [
        "诚实面对失败，选择一个有意义的失败案例",
        "分析具体原因，避免泛泛而谈",
        "强调从失败中学习到的经验和教训",
        "展示如何将经验应用到后续工作中，取得积极成果",
        "保持积极的态度，将失败视为成长的机会",
        "使用具体的数据和例子来支持你的故事",
        "展示你如何帮助团队从失败中学习",
      ],
    },
    {
      ...
      category: "领导力",
      description:
        "这个问题考查你的领导能力和团队管理能力。面试官希望了解你如何激励团队，解决问题，以及实现项目目标。",
      starAnswer: {
        situation:
          "我被任命为一个新项目的负责人，需要带领一个由5人组成的团队完成一个复杂的软件开发项目。团队成员来自不同背景，有些缺乏相关经验。",
        task: "我需要确保团队成员明确各自的职责，保持良好的沟通，并按时完成项目。同时，我需要帮助经验不足的成员快速成长。",
        action:
          "我首先组织了团队会议，明确项目目标和每个人的职责，根据成员的技能和经验分配任务。然后建立了每周例会制度，及时解决问题和调整计划。我还定期与团队成员进行一对一沟通，了解他们的困难并提供支持。对于经验不足的成员，我提供了额外的培训和指导，并安排有经验的成员进行结对编程。",
        result:
          "项目最终按时完成，质量达到了客户的要求。团队成员也表示在这个过程中收获了很多，团队凝聚力得到了提升。有两位经验不足的成员在项目结束后获得了晋升。",
      },
      alternativeAnswers: [
        {
          situation:
            "我所在的团队面临一个紧急项目，需要在两周内完成一个重要客户的定制化需求。团队成员都已经有其他工作负担。",
          task: "作为团队负责人，我需要合理分配任务，激励团队成员，确保项目按时完成。",
          action:
            "我首先与团队成员进行了沟通，了解他们的当前工作负担，然后重新调整了工作优先级。我将项目分解为小任务，明确每个任务的截止时间和负责人。我还与上级沟通，获得了额外的资源支持。在项目过程中，我每天与团队成员进行简短的站会，及时解决问题，并对团队的进展给予肯定和鼓励。",
          result:
            "团队最终按时完成了项目，客户非常满意。这次经历也增强了团队的凝聚力和应对紧急任务的能力。",
        },
      ],
      commonMistakes: [
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，合规和准确性是关键。强调你如何在确保合规的前提下，带领团队实现业务目标。",
        healthcare:
          "在医疗行业，患者安全和团队协作是核心。强调你如何带领跨专业团队，确保医疗质量和患者安全。",
      },
      tips: [
        "明确目标和职责，确保每个人都了解自己的角色",
        "建立有效的沟通机制，保持信息透明",
        "提供支持和指导，帮助团队成员成长",
        "激励团队成员，认可他们的贡献",
        "及时解决问题，调整计划",
    ...
    },
    {
      ...
      category: "抗压能力",
      description:
        "这个问题考查你的抗压能力和在压力下的表现。面试官希望了解你是否能够在压力下保持冷静，有效管理时间和资源，确保任务完成。",
      starAnswer: {
        situation:
          "在我之前的工作中，有一次客户突然要求在一周内完成原本需要一个月的项目修改。这意味着我们需要在短时间内完成大量工作，同时确保质量。",
        task: "我需要在短时间内完成项目修改，同时确保团队成员的工作负荷合理，避免 burnout。",
        action:
          "我首先制定了详细的工作计划，优先处理重要任务，并将工作分解为可管理的小块。然后与团队成员分工合作，明确每个任务的截止时间。我还与客户沟通，确认哪些功能是最关键的，哪些可以后续迭代。在工作过程中，我保持了良好的心态，通过短暂的休息和运动来缓解压力，并鼓励团队成员也这样做。",
        result:
          "我们最终按时完成了项目修改，客户对结果非常满意。这次经历也让我学会了如何在高压环境下保持高效工作，以及如何有效地管理时间和资源。",
      },
      alternativeAnswers: [
        {
          situation:
            "我曾经负责一个重要项目的上线，在上线前一天发现了一个严重的技术问题，需要在24小时内解决。",
          task: "我需要在有限的时间内解决技术问题，确保项目按时上线。",
          action:
            "我首先组建了一个应急团队，明确分工，然后分析问题的根本原因。我采用了系统化的调试方法，逐步缩小问题范围。在解决问题的过程中，我保持了冷静的心态，鼓励团队成员集思广益，并定期与上级沟通进展。",
          result:
            "我们最终在上线前成功解决了问题，项目按时上线，没有出现任何故障。这次经历让我学会了如何在高压环境下保持冷静，快速解决问题。",
        },
      ],
      commonMistakes: [
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，市场波动和 regulatory changes 可能带来压力。强调你如何在保持合规的前提下，应对紧急情况。",
        healthcare:
          "在医疗行业，紧急情况和患者安全压力很大。强调你如何在高压环境下保持专业判断，确保患者安全。",
      },
      tips: [
        "制定详细的计划，优先处理重要任务",
        "将大任务分解为小步骤，避免 overwhelm",
        "与团队成员合作，合理分配工作",
        "保持良好的心态，通过适当的方式缓解压力",
        "与 stakeholders 沟通，管理期望",
        "保持专注，避免分心",
        "定期休息，保持精力充沛",
        "事后复盘，总结经验教训",
      ],
    },
    {
      ...
      category: "创新能力",
      description:
        "这个问题考查你的创新能力和解决问题的能力。面试官希望了解你是否能够识别问题，提出创造性的解决方案，并成功实施。",
      starAnswer: {
        situation:
          "在我之前的公司，我们的客户服务流程效率低下，导致客户满意度下降。客户需要通过多个渠道提交请求，信息分散在不同系统中，导致响应时间长，错误率高。",
        task: "我需要找到一种方法来提高客户服务的效率和质量，提升客户满意度。",
        action:
          "我分析了现有的服务流程，发现问题在于信息传递不及时和重复工作。我提出了一个基于自动化的客户服务系统，将各个环节的信息整合起来，减少了重复工作。我与技术团队合作，设计了系统架构，并进行了原型测试。我还与客户服务团队沟通，了解他们的需求和痛点，确保系统能够满足实际需求。",
        result:
          "新系统实施后，客户服务响应时间减少了50%，客户满意度提高了20%。这个解决方案也被公司推广到其他部门，成为公司的标杆项目。我因此获得了年度创新奖。",
      },
      alternativeAnswers: [
        {
          situation:
            "我所在的团队负责开发一个移动应用，但用户留存率一直很低。通过用户调研，我发现用户对应用的导航和功能设计不满意。",
          task: "我需要提出创新的解决方案，提高用户留存率。",
          action:
            "我组织了一个设计思维工作坊，与团队成员和用户代表一起 brainstorming。我提出了一个基于用户行为数据的个性化导航系统，根据用户的使用习惯和偏好，动态调整应用的界面和功能。我与设计和开发团队合作，实现了这个功能，并进行了A/B测试。",
          result:
            "新功能上线后，用户留存率提高了35%，用户满意度也显著提升。这个功能成为了应用的核心特色，吸引了更多用户。",
        },
      ],
      commonMistakes: [
        "没有具体的创新案例，泛泛而谈",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，合规和风险管理是创新的前提。强调你如何在遵守 regulations 的前提下，创新金融产品和服务。",
        healthcare:
          "在医疗行业，患者安全是创新的首要考虑。强调你如何通过创新，提高医疗质量和患者体验。",
      },
      tips: [
        "分析问题的根本原因，而不是只解决表面症状",
        "寻找创新的解决方案，挑战传统思维",
        "收集数据和案例支持你的方案，验证可行性",
        "与团队合作实施，充分利用团队的专业知识",
        "进行原型测试，快速迭代改进",
  ...
  strategies: [
    {
      name: "STAR法则",
      description:
        "情境(Situation)、任务(Task)、行动(Action)、结果(Result)，结构化回答问题",
    },
    { name: "量化成果", description: "使用具体数字和数据来展示你的成就和影响" },
    { name: "自我反思", description: "展示你如何从失败中学习并不断改进" },
    {
      name: "团队导向",
      description: "强调团队合作和集体成就，而非个人英雄主义",
    },
...
const pressureDetails = ref({
  strategies: [
    {
      name: "保持冷静",
      description: "通过深呼吸和积极的自我暗示，保持冷静的心态面对压力",
    },
    {
      name: "快速分析",
      description: "快速理解问题核心，识别关键信息，避免陷入次要细节",
    },
    {
      name: "结构化回答",
      description: "即使时间有限，也要保持回答的结构清晰，先给出核心观点",
    },
    {
      name: "寻求澄清",
  ...
  scenarios: [
    {
      ...
      name: "时间压力",
      description:
        "面试官快速连续提问，要求在极短时间内给出答案，测试你的快速思维和表达能力。这种场景模拟了真实工作中需要快速决策的情况。",
      difficulty: "高",
      example:
        "面试官在5分钟内提出10个问题，每个问题只给30秒思考时间，包括技术问题、行为问题和情景问题。",
      应对策略: [
        {
          step: 1,
          title: "保持冷静",
          description:
            "深呼吸，保持微笑，避免表现出紧张或焦虑。记住，面试官是在测试你的抗压能力，而不是故意为难你。",
        },
        {
          step: 2,
          title: "快速分析",
        ...
        },
        {
          ...
          title: "结构化回答",
          description:
            "即使时间有限，也要保持回答的结构清晰，先给出核心观点，再简要展开。",
        },
        {
          step: 4,
          title: "寻求澄清",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，时间压力场景常见于市场波动、交易截止等情况。强调你如何在遵守 regulations 的前提下快速做出决策。",
        healthcare:
          "在医疗行业，时间压力场景常见于急诊、手术等情况。强调你如何在保证患者安全的前提下快速做出诊断和治疗决策。",
      },
      压力水平评估: {
    ...
    },
    {
      ...
      name: "批判性问题",
      description:
        "面试官质疑你的专业能力和项目经历，测试你的抗压能力和应变能力。这种场景模拟了真实工作中可能遇到的挑战和质疑。",
      difficulty: "高",
      example:
        "面试官质疑你的项目经验的真实性，或者对你的技术能力表示怀疑，不断追问细节，测试你的专业知识和自信心。",
      应对策略: [
        {
          step: 1,
          title: "保持冷静",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，批判性问题常见于对投资决策或风险管理的质疑。强调你如何在遵守 regulations 的前提下做出决策。",
        healthcare:
          "在医疗行业，批判性问题常见于对诊断或治疗方案的质疑。强调你如何基于医学证据和患者需求做出决策。",
      },
      压力水平评估: {
    ...
    },
    {
      ...
      name: "角色扮演",
      description:
        "模拟真实工作场景中的紧急情况，要求快速做出决策，测试你的应变能力和问题解决能力。这种场景模拟了真实工作中可能遇到的各种挑战。",
      difficulty: "中",
      example:
        "模拟客户投诉、团队冲突或项目紧急情况等场景，要求你在短时间内做出决策并采取行动。",
      应对策略: [
        {
          step: 1,
          title: "快速进入角色",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，角色扮演场景常见于客户服务、风险评估等情况。强调你如何在遵守 regulations 的前提下满足客户需求。",
        healthcare:
          "在医疗行业，角色扮演场景常见于患者沟通、急诊处理等情况。强调你如何在保证患者安全的前提下提供优质医疗服务。",
      },
      压力水平评估: {
    ...
    },
    {
      ...
      name: "多任务处理",
      description:
        "同时处理多个问题，测试你的注意力和优先级管理能力。这种场景模拟了真实工作中需要同时处理多项任务的情况。",
      difficulty: "中",
      example:
        "同时处理多个任务，如回答问题、查看文档、解决技术问题等，测试你的注意力分配和任务管理能力。",
      应对策略: [
        {
          step: 1,
          title: "优先级排序",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，多任务处理场景常见于交易、风险管理等情况。强调你如何在遵守 regulations 的前提下处理多个任务。",
        healthcare:
          "在医疗行业，多任务处理场景常见于急诊、病房管理等情况。强调你如何在保证患者安全的前提下处理多个任务。",
      },
      压力水平评估: {
    ...
    },
    {
      ...
      name: "技术挑战",
      description:
        "现场解决复杂技术问题，面试官不断追问细节，测试你的技术能力和抗压能力。这种场景模拟了真实工作中需要解决复杂技术问题的情况。",
      difficulty: "高",
      example:
        "现场解决算法问题、系统设计问题或调试问题，面试官不断追问技术细节和决策理由。",
      应对策略: [
        {
          step: 1,
          title: "理解问题",
      ...
      industrySpecific: {
        ...
        finance:
          "在金融行业，技术挑战场景常见于系统开发、风险建模等情况。强调你如何在保证安全性和合规性的前提下解决技术问题。",
        healthcare:
          "在医疗行业，技术挑战场景常见于医疗系统开发、数据分析等情况。强调你如何在保证患者安全和数据隐私的前提下解决技术问题。",
      },
      压力水平评估: {
...
<template>
  <div class="flex flex-col gap-6 max-w-7xl mx-auto min-h-[80vh]">
    ...
    <div
      ...
      class="flex flex-col gap-8 animate-in fade-in duration-500"
    >
      <div class="text-center space-y-4 py-8">
        <h1 class="text-4xl font-black text-neutral-title tracking-tight">
          AI 面试实战中心
        </h1>
        <p class="text-neutral-helper max-w-2xl mx-auto">
          通过高度仿真的 AI
          面试官，进行多维度岗位技能评测。提供实时反馈、压力测试及详细的能力报告。
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          v-for="card in [
            {
              title: '技术专项面试',
              desc: '深度考查前端、后端、架构等专业技术能力',
              icon: Zap,
              color: 'gradient-primary',
              action: toggleTechnicalDetails,
            },
            {
              title: '行为面试 (BQ)',
              desc: '评估软技能、领导力、团队协作及解决问题的能力',
              icon: Target,
              color: 'gradient-cyan-yellow',
              action: toggleBQDetails,
            },
            {
              title: '压力模拟面试',
              desc: '高强度连环追问，模拟真实大厂高压面试环境',
              icon: Zap,
              color: 'bg-auxiliary-orange',
              action: togglePressureDetails,
            },
          ]"
          :key="card.title"
          class="bg-white rounded-3xl border border-neutral-border p-8 shadow-sm hover:shadow-xl transition-all group cursor-pointer"
        >
          <div
            class="w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg"
            :class="card.color"
          >
            <component :is="card.icon" :size="28" />
          </div>
          <h3
            class="text-xl font-bold text-neutral-title mb-2 group-hover:text-primary transition-colors"
          >
            {{ card.title }}
          </h3>
          <p class="text-neutral-helper text-sm leading-relaxed mb-6">
            {{ card.desc }}
          </p>
          <div
            class="flex items-center gap-2 text-primary font-bold text-sm group-hover:translate-x-1 transition-transform cursor-pointer"
            @click="card.action"
          >
          ...
          >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div
                  v-for="type in technicalDetails.types"
                  :key="type.id"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:bg-primary/5 hover:border-primary/20 transition-all cursor-pointer group"
                  @click="showTechDetails(type)"
                >
                  ...
                  <div
                    class="w-full h-1 bg-neutral-border/30 rounded-full overflow-hidden"
                  >
                    <div
                      class="h-full bg-primary transition-all duration-500 group-hover:width-full"
                      :style="{ width: `${(type.questions / 200) * 100}%` }"
                    ></div>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(skill, index) in selectedTechType?.skills"
                        :key="index"
                        class="px-4 py-2 bg-primary/10 rounded-full text-sm font-medium text-primary"
                      >
                        {{ skill }}
                      </span>
                    </div>
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="space-y-4">
                      <div
                        v-for="(
                          question, index
                        ) in selectedTechType?.sampleQuestions"
                        :key="index"
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        <p
                          class="text-sm font-medium text-neutral-title leading-relaxed"
                        >
                          {{ index + 1 }}. {{ question }}
                        </p>
                      </div>
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="space-y-4">
                      <div
                        v-for="(path, index) in selectedTechType?.careerPaths"
                        :key="index"
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:shadow-md transition-all"
                      >
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(trend, index) in selectedTechType?.trends"
                        :key="index"
                        class="px-4 py-2 bg-primary/10 rounded-full text-sm font-medium text-primary"
                      >
                        {{ trend }}
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(tool, index) in selectedTechType?.tools"
                        :key="index"
                        class="px-4 py-2 bg-neutral-bg rounded-full text-sm font-medium text-neutral-title border border-neutral-border/50"
                      >
                        {{ tool }}
                      </span>
                    </div>
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div
                  v-for="level in technicalDetails.difficulty"
                  :key="level.level"
                  class="p-6 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:shadow-md transition-all"
                >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="space-y-4">
                <div
                  v-for="criterion in technicalDetails.criteria"
                  :key="criterion.name"
                  class="space-y-2"
                >
                  <div class="flex justify-between text-sm">
                    <span class="font-medium text-neutral-body">{{
                      criterion.name
                    }}</span>
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  v-for="(feature, index) in technicalDetails.features"
                  :key="index"
                  class="flex items-center gap-3 p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                >
                  <div
                  ...
                  <p class="text-sm font-medium text-neutral-title">
                    {{ feature }}
                  </p>
                </div>
              </div>
        ...
        >
          ...
          >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="space-y-4">
                <div
                  v-for="question in bqDetails.commonQuestions"
                  :key="question.id"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:bg-primary/5 hover:border-primary/20 transition-all cursor-pointer group"
                  @click="openBQQuestionDetails(question)"
                >
            ...
            <Transition name="fade">
              ...
              >
                ...
                >
                  ...
                  <div
                    v-if="
                      selectedBQQuestion?.alternativeAnswers &&
                      selectedBQQuestion.alternativeAnswers.length > 0
                    "
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                      备选答案
                    </h3>
                    <div class="space-y-6">
                      <div
                        v-for="(
                          answer, index
                        ) in selectedBQQuestion?.alternativeAnswers"
                        :key="index"
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        <h4 class="text-sm font-bold text-primary mb-2">
                        ...
                        <div class="space-y-3 mt-3">
                          <div>
                            <h5
                              class="text-xs font-medium text-neutral-helper mb-1"
                            >
                              情境 (Situation)
                            </h5>
                            <p class="text-sm text-neutral-title">
                  ...
                  <div
                    v-if="
                      selectedBQQuestion?.commonMistakes &&
                      selectedBQQuestion.commonMistakes.length > 0
                    "
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                    ...
                    <div class="space-y-2">
                      <div
                        v-for="(
                          mistake, index
                        ) in selectedBQQuestion?.commonMistakes"
                        :key="index"
                        class="flex items-start gap-3 p-3 bg-neutral-bg rounded-xl border border-neutral-border/50"
                      >
                        <div
                          class="w-6 h-6 rounded-full bg-auxiliary-red/10 flex items-center justify-center text-auxiliary-red flex-shrink-0 mt-0.5"
                        >
                          <X :size="14" />
                        </div>
                  ...
                  <div
                    v-if="selectedBQQuestion?.industrySpecific"
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                      行业特定建议
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <p class="text-sm text-neutral-title">
                          {{ selectedBQQuestion?.industrySpecific.tech }}
                        </p>
                      </div>
                      <div
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        ...
                        <p class="text-sm text-neutral-title">
                          {{ selectedBQQuestion?.industrySpecific.finance }}
                        </p>
                      </div>
                      <div
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        ...
                        <p class="text-sm text-neutral-title">
                          {{ selectedBQQuestion?.industrySpecific.healthcare }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(tip, index) in selectedBQQuestion?.tips"
                        :key="index"
                        class="px-4 py-2 bg-neutral-bg rounded-full text-sm font-medium text-neutral-title border border-neutral-border/50"
                      >
                        {{ tip }}
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div
                  v-for="strategy in bqDetails.strategies"
                  :key="strategy.name"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:shadow-md transition-all"
                >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="space-y-4">
                <div
                  v-for="criterion in bqDetails.evaluationCriteria"
                  :key="criterion.name"
                  class="space-y-2"
                >
                  <div class="flex justify-between text-sm">
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  v-for="(feature, index) in bqDetails.features"
                  :key="index"
                  class="flex items-center gap-3 p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                >
                  <div
        ...
        >
          ...
          >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div
                  v-for="scenario in pressureDetails.scenarios"
                  :key="scenario.id"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:bg-primary/5 hover:border-primary/20 transition-all cursor-pointer group"
                  @click="openPressureScenarioDetails(scenario)"
                >
                  <div class="flex items-center gap-3 mb-3">
                    <div
                      class="px-3 py-1 bg-auxiliary-orange/10 rounded-full text-xs font-bold text-auxiliary-orange"
                    >
            ...
            <Transition name="fade">
              <div
                v-if="showPressureScenarioDetails"
                class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4"
              >
                <div
                  class="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-300"
                >
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="mt-4">
                      <div
                        class="px-3 py-1 bg-auxiliary-orange/10 rounded-full text-xs font-bold text-auxiliary-orange inline-block mb-3"
                      >
                  ...
                  <div
                    v-if="
                      selectedPressureScenario?.应对策略 &&
                      selectedPressureScenario.应对策略.length > 0
                    "
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                    ...
                    <div class="space-y-4">
                      <div
                        v-for="(
                          strategy, index
                        ) in selectedPressureScenario?.应对策略"
                        :key="index"
                        class="flex gap-4 p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        <div
                          class="w-8 h-8 rounded-full bg-auxiliary-orange/10 flex items-center justify-center text-auxiliary-orange flex-shrink-0"
                        >
                          {{ strategy.step }}
                        </div>
                        <div>
                  ...
                  <!-- Industry Specific Advice -->
                  <div
                    v-if="selectedPressureScenario?.industrySpecific"
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                      行业特定建议
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        <h4
                          class="text-sm font-bold text-auxiliary-orange mb-2"
                        >
                          科技行业
                        </h4>
                        <p class="text-sm text-neutral-title">
                          {{ selectedPressureScenario?.industrySpecific.tech }}
                        </p>
                      </div>
                      <div
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        ...
                        <p class="text-sm text-neutral-title">
                          {{
                            selectedPressureScenario?.industrySpecific.finance
                          }}
                        </p>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <p class="text-sm text-neutral-title">
                          {{
                            selectedPressureScenario?.industrySpecific
                              .healthcare
                          }}
                        </p>
                      </div>
                  ...
                  <div
                    v-if="selectedPressureScenario?.压力水平评估"
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                      压力水平评估
                    ...
                    <div class="space-y-3">
                      ...
                      >
                        ...
                        <p class="text-sm text-neutral-helper">
                          {{ selectedPressureScenario?.压力水平评估.low }}
                        </p>
                      </div>
                      <div
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        ...
                        <p class="text-sm text-neutral-helper">
                          {{ selectedPressureScenario?.压力水平评估.medium }}
                        </p>
                      </div>
                      <div
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        <div class="flex justify-between items-center mb-2">
                          ...
                          <span
                            class="px-3 py-1 bg-auxiliary-red/10 rounded-full text-xs font-bold text-auxiliary-red"
                            >高级</span
                          >
                        </div>
                        <p class="text-sm text-neutral-helper">
                          {{ selectedPressureScenario?.压力水平评估.high }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <span
                        v-for="(tip, index) in selectedPressureScenario?.tips"
                        :key="index"
                        class="px-4 py-2 bg-neutral-bg rounded-full text-sm font-medium text-neutral-title border border-neutral-border/50"
                      >
                        {{ tip }}
                  ...
                  <div class="p-8 border-b border-neutral-border">
                    ...
                    <div class="space-y-6">
                      <div
                        v-for="(
                          question, index
                        ) in selectedPressureScenario?.sampleQuestions"
                        :key="index"
                        class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                      >
                        ...
                        <div class="p-3 bg-primary/5 rounded-xl">
                          <h5 class="text-xs font-bold text-primary mb-2">
                            参考答案
                          </h5>
                          <p class="text-sm text-neutral-title">
                  ...
                  <div
                    v-if="
                      selectedPressureScenario?.feedback &&
                      selectedPressureScenario.feedback.length > 0
                    "
                    class="p-8 border-b border-neutral-border"
                  >
                    <h3 class="text-lg font-bold text-neutral-title mb-6">
                    ...
                    <div class="space-y-2">
                      <div
                        v-for="(
                          item, index
                        ) in selectedPressureScenario?.feedback"
                        :key="index"
                        class="flex items-start gap-3 p-3 bg-neutral-bg rounded-xl border border-neutral-border/50"
                      >
                        <div
                          class="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary flex-shrink-0 mt-0.5"
                        >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div
                  v-for="strategy in pressureDetails.strategies"
                  :key="strategy.name"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:shadow-md transition-all"
                >
                  <h4 class="font-bold text-neutral-title mb-2">
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="space-y-4">
                <div
                  v-for="criterion in pressureDetails.evaluationCriteria"
                  :key="criterion.name"
                  class="space-y-2"
                >
                  <div class="flex justify-between text-sm">
                    ...
                    <span class="font-bold text-auxiliary-orange"
                      >{{ criterion.weight }}%</span
                    >
                  </div>
                  <div class="h-2 bg-neutral-bg rounded-full overflow-hidden">
                    <div
                      class="h-full bg-auxiliary-orange transition-all duration-1000"
                      :style="{ width: `${criterion.weight}%` }"
                    ></div>
                  </div>
                </div>
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="space-y-4">
                <div
                  v-for="(question, index) in pressureDetails.sampleQuestions"
                  :key="index"
                  class="p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50 hover:bg-primary/5 hover:border-primary/20 transition-all"
                >
                  <p
                    class="text-sm font-medium text-neutral-title leading-relaxed"
                  >
            ...
            <div class="p-8 border-b border-neutral-border">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  v-for="(feature, index) in pressureDetails.features"
                  :key="index"
                  class="flex items-center gap-3 p-4 bg-neutral-bg rounded-2xl border border-neutral-border/50"
                >
                  <div
                    class="w-8 h-8 rounded-full bg-auxiliary-orange/10 flex items-center justify-center text-auxiliary-orange"
                  >
                    <CheckCircle2 :size="16" />
                  </div>
                  <p class="text-sm font-medium text-neutral-title">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          class="bg-white rounded-3xl border border-neutral-border p-12 shadow-sm flex flex-col items-center text-center"
          style="width: 1280px"
        >
          <div
            class="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center text-primary mb-6"
          >
            <Briefcase :size="40" />
          </div>
          <h2 class="text-2xl font-bold text-neutral-title mb-4">
            准备好开始你的挑战了吗？
          </h2>
    ...
    <!-- 2. Prepare Step -->
    <div
      v-else-if="currentStep === 'prepare'"
      class="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in slide-in-from-bottom-8 duration-500"
    >
      <!-- Left: Device & Resume -->
      <div class="lg:col-span-8 flex flex-col gap-6">
        <div
          class="bg-white rounded-3xl border border-neutral-border p-8 shadow-sm"
        >
          <h3
            class="text-xl font-bold text-neutral-title mb-8 flex items-center gap-2"
          >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <p
                  class="text-sm font-bold text-neutral-title flex items-center gap-2"
                >
                ...
                <span
                  v-if="cameraReady"
                  class="text-xs text-auxiliary-green font-bold flex items-center gap-1"
                >
                  <ShieldCheck :size="14" /> 正常
                </span>
              </div>
              <div
                class="aspect-video bg-neutral-bg rounded-2xl border-2 border-dashed border-neutral-border overflow-hidden relative group"
              >
                <video
                  ref="videoRef"
                  autoplay
                ...
                <div
                  v-if="!cameraReady"
                  class="absolute inset-0 flex items-center justify-center text-neutral-helper"
                >
                  正在请求摄像头权限...
                </div>
              </div>
            ...
            <div class="space-y-4">
              ...
              <div
                class="h-[120px] bg-neutral-bg rounded-2xl flex items-center justify-center px-8 relative"
              >
                <div
                  class="w-full h-4 bg-neutral-border/30 rounded-full overflow-hidden"
                >
                  <div
                    class="h-full gradient-primary transition-all duration-100"
                    :style="{ width: `${audioLevel}%` }"
                  ></div>
                </div>
                <p
                  class="absolute bottom-4 text-[10px] text-neutral-helper font-medium"
                >
                  请尝试说话，观察能量条波动
                </p>
              </div>
              ...
              <div class="pt-4 space-y-3">
                ...
                <select
                  v-model="selectedJob"
                  class="w-full p-4 bg-neutral-bg rounded-xl border-none text-sm font-bold text-neutral-title focus:ring-2 focus:ring-primary/20 cursor-pointer"
                >
        ...
        >
          <div class="flex items-center justify-between mb-6">
            <h3
              class="text-lg font-bold text-neutral-title flex items-center gap-2"
            >
              <FileUp :size="20" class="text-primary" />
              简历 AI 分析
            </h3>
            <span v-if="resumeFile" class="text-xs text-primary font-bold">{{
              resumeFile.name
            }}</span>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              />
              <div
                class="w-12 h-12 bg-neutral-bg rounded-full flex items-center justify-center text-neutral-helper group-hover:text-primary group-hover:bg-primary/10 transition-all"
              >
                <FileUp :size="24" />
              </div>
            ...
            <div class="bg-neutral-bg rounded-2xl p-6 relative overflow-hidden">
              <div
                v-if="isAnalyzingResume"
                class="absolute inset-0 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center gap-4 z-10"
              >
                <div
                  class="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin"
                ></div>
                <p class="text-xs font-bold text-primary animate-pulse">
                  AI 正在深度解析简历内容...
                </p>
              </div>
              <div v-if="resumeAnalysisResult" class="space-y-3">
                <p
                  class="text-xs font-bold text-primary flex items-center gap-1 uppercase"
                >
              ...
              >
                <p class="text-xs text-neutral-helper italic">
                  上传简历后，AI 将自动分析您的优势并定制面试题目
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="lg:col-span-4 flex flex-col gap-6">
        <div
          class="bg-white rounded-3xl border border-neutral-border p-8 shadow-sm sticky top-6"
        >
          ...
          <div class="space-y-4 mb-8">
            <div
              ...
              :key="item.label"
              class="flex items-center justify-between p-4 rounded-2xl bg-neutral-bg transition-all"
            >
              <span class="text-sm font-medium text-neutral-body">{{
                item.label
              }}</span>
              <div
                ...
                :class="
                  item.ready
                    ? 'bg-auxiliary-green text-white'
                    : 'bg-neutral-border/50 text-white'
                "
              >
                <CheckCircle2 :size="14" />
              </div>
          ...
          <p
            class="mt-4 text-[10px] text-neutral-helper text-center leading-relaxed"
          >
            点击“开始面试”即代表您同意 AI
            实时捕捉音视频画面用于面试评估，数据将在会话结束后自动加密。
          </p>
        </div>
      </div>
    </div>
    ...
    <template v-else-if="currentStep === 'ongoing'">
      ...
      <div
        class="flex flex-wrap items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-neutral-border shadow-sm"
      >
        <div class="flex items-center gap-6">
          ...
          <div class="flex bg-neutral-bg p-1 rounded-xl">
            <button
              v-for="mode in [
                { id: 'technical', label: '技术面试', icon: Zap },
                { id: 'group', label: '小组面试', icon: Users },
                { id: 'leaderless', label: '无领导小组', icon: MessageCircle },
              ]"
              :key="mode.id"
              ...
              :class="
                interviewMode === mode.id
                  ...
                  : 'text-neutral-helper hover:text-neutral-body'
              "
          ...
          <!-- Difficulty -->
          <div
            class="flex items-center gap-2 px-4 py-2 bg-neutral-bg rounded-xl"
          >
            <Trophy :size="16" class="text-auxiliary-orange" />
            <select
              v-model="difficulty"
              class="bg-transparent border-none text-xs font-bold text-neutral-title focus:ring-0 cursor-pointer"
            >
        ...
        <div class="flex items-center gap-4">
          <div
            class="flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-xl text-primary font-bold text-sm"
          >
            <History :size="16" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div class="lg:col-span-8 flex flex-col gap-6">
          <!-- Question Card -->
          <div
            class="bg-white rounded-3xl border border-neutral-border p-8 shadow-sm relative overflow-hidden group"
          >
            <div class="flex justify-between items-start mb-6">
              <div class="flex items-center gap-4">
                <div
                  class="w-12 h-12 rounded-2xl gradient-cyan-yellow flex items-center justify-center text-primary font-bold text-xl shadow-inner"
                >
                  Q{{ answeredCount + 1 }}
                </div>
                <div>
              ...
              >
                ...
                <span
                  ...
                  :class="
                    timeLeft < 10
                      ? 'text-auxiliary-orange animate-pulse'
                      : 'text-primary'
                  "
                >
            ...
            <p
              class="text-xl text-neutral-title leading-relaxed font-medium mb-6"
            >
              {{ currentQuestion }}
            </p>
            ...
            <Transition name="fade">
              <div
                ...
                class="mt-6 p-6 bg-primary/5 rounded-2xl border border-primary/20 animate-in slide-in-from-top-4 duration-300"
              >
                <p
                  class="text-xs font-bold text-primary mb-2 uppercase tracking-widest"
                >
                  AI 模型参考答案：
                </p>
                <p class="text-sm text-neutral-body leading-relaxed">
                  Vue3 响应式原理基于 ES6 的 Proxy 实现。相比 Vue2 的
                  Object.defineProperty，Proxy
                  可以直接监听对象而非属性，支持数组索引变化监听，且无需递归初始化，极大提升了性能和灵活性。
                </p>
              </div>
            </Transition>
          </div>
          ...
          <!-- Answer Area -->
          <div
            class="bg-white rounded-3xl border border-neutral-border p-8 shadow-sm flex-1 flex flex-col gap-6 relative"
          >
            <!-- Floating Camera Feed -->
            <div
              class="absolute top-6 right-6 w-32 aspect-video bg-neutral-bg rounded-xl border border-neutral-border overflow-hidden shadow-lg z-10"
            >
              <video
                ref="videoRefOngoing"
                autoplay
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-4 mr-36">
                <div
                  v-if="isRecording"
                  class="flex items-center gap-2 text-auxiliary-orange bg-auxiliary-orange/10 px-3 py-1 rounded-full text-xs font-bold animate-pulse"
                >
                  语音识别中...
                </div>
                <span class="text-xs text-neutral-helper"
                  >{{ answerText.length }} / 2000 字</span
                >
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              <button
                ...
                :class="
                  isRecording
                    ...
                    : 'bg-neutral-bg text-neutral-title hover:bg-primary/10 hover:text-primary'
                "
              ...
              <div class="flex gap-3">
                <button
                  class="px-6 py-3 bg-neutral-bg text-neutral-body font-bold rounded-2xl hover:bg-neutral-border/50 transition-all flex items-center gap-2"
                >
                  <SkipForward :size="18" />
                  跳过
                </button>
        ...
        <div class="lg:col-span-4 flex flex-col gap-6">
          <!-- Progress Card -->
          <div
            class="bg-white rounded-3xl border border-neutral-border p-6 shadow-sm"
          >
            <div class="flex justify-between items-end mb-4">
              <div>
                <p class="text-xs text-neutral-helper uppercase mb-1">
                  已完成题数
                </p>
                <div class="flex items-baseline gap-1">
                  ...
                  <span class="text-sm text-neutral-helper font-medium"
                    >/ {{ totalQuestions }}</span
                  >
                </div>
              </div>
              <div class="text-right">
                ...
                <p class="text-xl font-black text-auxiliary-green">
                  {{ matchingScore }}%
                </p>
              </div>
            </div>
          ...
          <!-- AI Feedback -->
          <div
            class="bg-white rounded-3xl border border-neutral-border p-6 shadow-sm flex-1 flex flex-col"
          >
            <h3
            ...
            <div class="space-y-6 flex-1">
              <div
                v-for="metric in [
                  { label: '专业知识深度', value: fluencyScore },
                  { label: '表达逻辑条理', value: logicScore },
                ]"
                :key="metric.label"
                class="space-y-2"
              >
              ...
              >
                <p
                  class="text-xs font-bold text-neutral-title mb-1 flex items-center gap-1"
                >
                  <AlertCircle :size="12" class="text-auxiliary-orange" />
                  面试复盘建议
                </p>
                <p class="text-[11px] text-neutral-body leading-relaxed">
                  在回答 Vue3 优势时，如果能对比 **Tree-shaking**
                  的支持，评分将更高。
                </p>
              </div>
            </div>
          ...
          <button
            class="w-full py-4 bg-auxiliary-orange/10 text-auxiliary-orange font-bold rounded-2xl hover:bg-auxiliary-orange hover:text-white transition-all duration-300 flex items-center justify-center gap-2 group shadow-sm"
            @click="currentStep = 'home'"
          >
            <Square :size="18" />
            终止当前面试
          </button>
    ...
    <!-- 4. Finished Step -->
    <div
      v-else-if="currentStep === 'finished'"
      class="bg-white rounded-[32px] p-12 shadow-xl border border-neutral-border max-w-5xl mx-auto animate-in zoom-in-95 duration-500"
    >
      <div class="text-center mb-12">
        <div
          class="w-20 h-20 gradient-primary rounded-3xl flex items-center justify-center text-white mx-auto mb-8 shadow-lg shadow-primary/30"
        >
          <CheckCircle2 :size="40" />
        </div>
        <h2 class="text-4xl font-black text-neutral-title mb-4 tracking-tight">
          面试挑战已完成！
        </h2>
        <p class="text-neutral-helper">
          基于 AI 岗位图谱分析，您本次的表现如下：
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div
          class="bg-neutral-bg p-6 rounded-3xl border border-neutral-border/50"
        >
          <p class="text-xs text-neutral-helper uppercase mb-2">
            Offer 胜算 Rank
          </p>
        ...
        >
          ...
          <p class="text-3xl font-black text-auxiliary-green">
            {{ interviewResults.overallScore + 5 }}%
          </p>
        </div>
        <div
          class="bg-neutral-bg p-6 rounded-3xl border border-neutral-border/50"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <!-- Strengths -->
        <div
          class="bg-auxiliary-green/5 p-6 rounded-3xl border border-auxiliary-green/20"
        >
          <h3
            class="text-xl font-bold text-auxiliary-green mb-6 flex items-center gap-2"
          >
          ...
          <ul class="space-y-4">
            <li
              v-for="(strength, index) in interviewResults.strengths"
              :key="index"
              class="flex items-start gap-3"
            >
              <div
                class="w-6 h-6 rounded-full bg-auxiliary-green/20 flex items-center justify-center text-auxiliary-green mt-0.5 flex-shrink-0"
              >
                <CheckCircle2 :size="14" />
              </div>
              <p class="text-neutral-title text-sm leading-relaxed">
                {{ strength }}
              </p>
            </li>
          </ul>
        ...
        <!-- Weaknesses -->
        <div
          class="bg-auxiliary-orange/5 p-6 rounded-3xl border border-auxiliary-orange/20"
        >
          <h3
            class="text-xl font-bold text-auxiliary-orange mb-6 flex items-center gap-2"
          >
            <AlertCircle :size="24" />
            改进空间
          </h3>
          <ul class="space-y-4">
            <li
              v-for="(weakness, index) in interviewResults.weaknesses"
              :key="index"
              class="flex items-start gap-3"
            >
              <div
                class="w-6 h-6 rounded-full bg-auxiliary-orange/20 flex items-center justify-center text-auxiliary-orange mt-0.5 flex-shrink-0"
              >
                <AlertCircle :size="14" />
              </div>
              <p class="text-neutral-title text-sm leading-relaxed">
      ...
      <!-- Detailed Scores -->
      <div
        class="bg-neutral-bg p-8 rounded-3xl border border-neutral-border/50 mb-12"
      >
        <h3 class="text-xl font-bold text-neutral-title mb-6">能力维度评估</h3>
        <div class="space-y-4">
          <div
            v-for="(score, key) in interviewResults.detailedScores"
            :key="key"
            class="space-y-2"
          >
            <div class="flex justify-between text-sm">
      ...
      <div class="bg-primary/5 p-8 rounded-3xl border border-primary/20 mb-12">
        ...
        <ul class="space-y-4">
          <li
            v-if="interviewMode === 'technical'"
            class="text-neutral-title text-sm leading-relaxed"
          >
            • 建议加强对高级技术概念的学习，特别是
            {{
          ...
          <li
            v-if="interviewMode === 'behavioral'"
            class="text-neutral-title text-sm leading-relaxed"
          >
            • 建议参与更多团队项目，提升
            {{
              (interviewResults.detailedScores.leadership || 0) < 80
                ? "领导力"
                : (interviewResults.detailedScores.teamwork || 0) < 80
                  ? "团队协作"
                  : "沟通表达"
            }}
            能力。
          ...
          <li
            v-if="interviewMode === 'pressure'"
            class="text-neutral-title text-sm leading-relaxed"
          >
            • 建议进行更多高压场景的模拟训练，提升
            {{
              (interviewResults.detailedScores.stressManagement || 0) < 80
                ? "压力管理"
                : (interviewResults.detailedScores.quickThinking || 0) < 80
                  ? "快速思维"
                  : "决策能力"
            }}。
          </li>
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <button
          class="px-10 py-4 gradient-primary text-white font-bold rounded-2xl shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center gap-2"
        ...
        <button
          class="px-10 py-4 bg-neutral-bg text-neutral-title font-bold rounded-2xl hover:bg-neutral-border/50 transition-all"
          @click="currentStep = 'home'"
        >
          返回主页
        </button>
