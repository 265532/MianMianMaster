...
export const notificationApi = {
  getNotifications(params?: {
    ...
    return get<ResponseModel<Notification[]>>(
      `${BASE_URL}`,
  ...
  getPreferences(): Promise<ResponseModel<NotificationPreferences>> {
    return get<ResponseModel<NotificationPreferences>>(
  ...
  ): Promise<ResponseModel<NotificationPreferences>> {
    return put<ResponseModel<NotificationPreferences>>(
      `${BASE_URL}/preferences`,
      data,
    );
  },
