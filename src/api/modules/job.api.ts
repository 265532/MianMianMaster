...
export const jobApi = {
  createJobPosition(data: JobPositionCreate): Promise<ResponseModel<JobPosition>> {
    return post<ResponseModel<JobPosition>>(`${BASE_URL}`, data)
  },

  listJobPositions(params?: PaginationParams): Promise<ResponseModel<JobPosition[]>> {
    return get<ResponseModel<JobPosition[]>>(`${BASE_URL}`, params as Record<string, any>)
  },
