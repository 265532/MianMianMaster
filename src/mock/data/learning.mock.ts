...
export const mockCourses: Course[] = [
  {
    ...
    title: "逻辑思维提升",
    description:
      "通过系统训练提升逻辑思维能力，掌握结构化思考方法，提高面试中的问题分析和解决能力。",
    category: "逻辑思维",
    difficulty: "easy",
  ...
  },
  {
    ...
    title: "表达结构优化",
    description:
      "学习STAR法则等表达技巧，掌握清晰、有条理的表达方法，提高面试中的沟通效果。",
    category: "表达结构",
    difficulty: "medium",
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-05-09T00:00:00Z",
  },
  {
    ...
    title: "专业深度强化",
    description:
      "深入探讨技术领域的核心概念和前沿趋势，提升专业知识深度，应对技术面试中的 challenging questions。",
    category: "专业深度",
    difficulty: "hard",
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-05-09T00:00:00Z",
  },
  {
    ...
    title: "面试技巧全攻略",
    description:
      "全面覆盖面试各个环节的技巧，包括简历准备、自我介绍、行为问题回答、薪资谈判等。",
    category: "面试技巧",
    difficulty: "easy",
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-05-09T00:00:00Z",
...
export const mockWrongQuestions: WrongQuestion[] = [
  ...
  },
  {
    ...
    correct_answer:
      "使用 memo、useCallback、useMemo、虚拟列表、代码分割等多种方式",
    explanation:
  ...
  },
  {
    ...
    user_answer:
      "事件冒泡是从子元素向父元素传播，事件捕获是从父元素向子元素传播",
    correct_answer:
...
export const mockUserBadges: UserBadge[] = [
  ...
  },
  {
    ...
    badge_id: 3,
    badge: mockBadges[2],
    awarded_at: "2026-03-18T00:00:00Z",
  },
];
