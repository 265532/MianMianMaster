...
import { setToken, getToken, removeToken, isLoggedIn, cacheUserInfo, getCachedUserInfo } from '../auth'
...
describe('auth utils', () => {
  ...
  describe('user info cache', () => {
    it('should cache and retrieve user info', () => {
      const userInfo = { id: '1', name: 'test', email: 'test@test.com', avatar: '', isAuthenticated: true, role: 'user' as const, skills: [] }
